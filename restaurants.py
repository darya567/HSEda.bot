...
restaurants = [
        ...
        Restaurant(
            id=20, 
            title='Ахтуба',
            description='Столовая «Ахтуба» - самая близкая к корпусу на Большой Печёрской точка питания. Если вы устали после занятий, и у вас совсем не осталось сил никуда идти, то вам точно стоит заглянуть «Ахтубу»! \n В этой столовой есть и первые, и вторые, и горячие блюда, а также салаты. Столовая способна удивить и любителей чая своими необычными ароматами чая, и кофеманов вкусом свежесваренного кофе. \n P.S. В столовой можно заказать бизнес-ланч всего за 309 рублей, состоящий из первого, второго, салата и напитка.',
            photo_url='https://avatars.mds.yandex.net/get-altay/6195924/2a0000018f8683d779328705ec38ea46fd9c/XXXL.jpg',
