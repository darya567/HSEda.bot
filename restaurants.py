...
restaurants = [
        ...
        Restaurant(
         ...
         Restaurant(
            ...
            address='Нижний Новгород, ул. Большая Покровская, 47\nНижний Новгород, ул. Минина, 12\nНижний Новгород, ул. Героя Фильченкова, 12',
            avg_price=500.0
            ),
         Restaurant(
            id=8,  
            ...
            address='Нижний Новгород, ул. Большая Покровская, 2\nНижний Новгород, ул. Большая Печерская, 44\nНижний Новгород, ул. Ковалихинская, 4А\nНижний Новгород, ул. Верхне-Волжская набережная, 2а',
            avg_price=300.0
            ),
        Restaurant(
            id=9, 
        ...
        Restaurant(
            ...
            photo_url='https://avatars.mds.yandex.net/get-altay/10156117/2a0000018c00cdf48a61d36b867f4a854545/L_height',
            address='Нижний Новгород, ул. Большая Покровская, 2 — 1 этаж',
            avg_price=550.0
            ),
        Restaurant(
            id=15,
        ...
        Restaurant(
            ...
            address='Нижний Новгород, ул. Большая Печёрская, 26',
            avg_price=1500.0
            ),
        Restaurant(
            id=20, 
        ...
        Restaurant(
            ...
            address='Нижний Новгород, ул. Пискунова, 31А, этаж 1',
            avg_price=300.0
            ),
        Restaurant(
            id=22, 
            ...
            address='Нижний Новгород, ул. Большая Печёрская, 37, этаж цокольный',
            avg_price=370.0
            ),
        Restaurant(
            id=23, 
            ...
            address='Нижний Новгород, ул. Большая Покровская, 60',
            avg_price=400.0
            ),
         Restaurant(
            id=24, 
            title='ДОМакарон',
            description='«Кафе «ДОМакарон» — это место, где вы можете насладиться вкусной и сытной едой, приготовленной с любовью. Вежливый и отзывчивый персонал, большие порции, чистая и уютная атмосферf в самом кафе. С 11:00 до 16:00 продаются бизнес-ланчи стоимостью от 290 до 350 рублей',
            photo_url='https://avatars.mds.yandex.net/get-altay/11622009/2a0000018f229f3b37de6c6723f65d748daf/XXXL',
            address='Нижний Новгород, площадь Революции, 2А, этаж 2',
            avg_price=400.0
            ),
        Restaurant(
            id=25, 
            title='Мануфактура',
            description='«Мануфактура» — это кафе, где можно попробовать традиционную дагестанскую кухню или классическую европейскую. Интерьер кафе сочетает современный стиль с национальными дагестанскими элементами. Полноценные завтраки и вкусная выпечка',
            photo_url='https://avatars.mds.yandex.net/get-altay/13604236/2a00000191bd5d5213d1ff5e8491db2b940f/XXXL',
            address='Нижний Новгород, ул. Ковалихинская, 8, этаж 1',
            avg_price=500.0
            ),
        Restaurant(
            id=26, 
            title='Onne poke',
            description='Onne Poke — это кафе, которое специализируется на блюдах гавайской кухни, таких как поке и боулы.\nP.S. По вс-чт с 11 до 17 бизнес-ланч и можно вкусно поесть за небольшую цену.',
            photo_url='https://avatars.mds.yandex.net/get-altay/5475658/2a00000181e8ad6d3d45bd95450869e1774c/L_height',  
            address='Нижний Новгород, ул. Ковалихинская, 4a',
            avg_price=550.0
            ),
        Restaurant(
            id=27, 
            title='Краснодарский парень',
            description='«Краснодарский Парень» — международная сеть бургерных с южным характером. Мы апгрейднули фастфуд до максимума, чтобы он стал нормальной едой (цитата твоей мамы). Свежие овощи с южных полей, котлеты из мраморной говядины, мягкие булочки — все настоящее.',
            photo_url='https://sun83-1.userapi.com/impg/Cjm8ujIj5Ou4W-O-eciPYX-39k89766JvDxU9w/S75tFtkrbd0.jpg?size=2560x2079&quality=95&sign=9adc78043ef95c46113d5124ef425570&type=album.jpg',
            address='Нижний Новгород, ул. Большая Покровская, 32',
            avg_price=600.0
            ),
        Restaurant(
            id=28, 
            title='Pronto PIZZA e PASTA',
            description='Пиццерия Pronto Pizza e Pasta — это уютное место с летней верандой, где можно насладиться вкусной пиццей и пастой, а также другими блюдами итальянской кухни, такими как салаты, супы, горячее и десерты.',
            photo_url='https://dynamic-media-cdn.tripadvisor.com/media/photo-o/12/57/d9/22/1.jpg?w=1200&h=-1&s=1',
            address='Нижний Новгород, ул. Ижорская, 4',
            avg_price=700.0
            ),
          Restaurant(
            id=29, 
            title='Хартут',
            description='Главная задача нашего кафе - это внимательное и заботливое отношение к каждому гостю. Наше кафе встретит Вас домашней кухней, отменными блюдами на мангале, вкуснейшими десертами, отличным качеством обслуживания и демократичными ценами.',
            photo_url='https://avatars.mds.yandex.net/get-altay/1987173/2a00000173a41e12064f40cd49839a3767d9/L_height',
            address='Нижний Новгород, ул. Грузинская, 40',
            avg_price=1100.0
            ),
