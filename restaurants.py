...
restaurants = [
        ...
        Restaurant(
         ...
         Restaurant(
            id=24, 
            title='ДОМакарон',
            description='«Кафе «ДОМакарон» — это место, где вы можете насладиться вкусной и сытной едой, приготовленной с любовью. Вежливый и отзывчивый персонал, большие порции, чистая и уютная атмосфера в самом кафе. С 11:00 до 16:00 продаются бизнес-ланчи стоимостью от 290 до 350 рублей',
